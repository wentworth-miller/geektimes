        ...
        try {
            ...
            if (Objects.nonNull(entity)) {
                ...
                if (Objects.nonNull(mediaType)) {
                    connection.setRequestProperty("Content-Type", mediaType.getType() + "/" + mediaType.getSubtype());
                }
                if (Objects.nonNull(entity.getEntity())) {
                    connection.setDoOutput(true);
                    String param = (String)entity.getEntity();
